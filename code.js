...
// get designer's name
const getDesignersName = () =>
  __awaiter(this, void 0, void 0, function*() {
    const name = yield figma.clientStorage.getAsync('USER_NAME');
    figma.ui.postMessage({
      type: 'GET_STORED_USER_NAME',
      name
    });
  });
getDesignersName();
...
figma.ui.onmessage = msg => {
  ...
  console.log(msg);
  if (msg.type === 'SAVE_USER_NAME') {
    const { userName } = msg;
    figma.clientStorage.setAsync('USER_NAME', userName);
  }
};
